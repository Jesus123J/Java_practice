...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
          setEchoChar('\u2022');
        setBorder(new EmptyBorder(20, 3, 23, 30));
        ...
        eye = new javax.swing.ImageIcon(getClass().getResource("/eye.png")).getImage();
        eye_hide = new javax.swing.ImageIcon(getClass().getResource("/eye_hide.png")).getImage();
    ...
    private void createHelperText(Graphics2D g2) {
        if (helperText != null && !helperText.equals("")) {
            ...
            g2.drawString(helperText, in.right- 27, (int) (height + ft.getAscent() - textY));
        }
    }
    ...
    public void paint(Graphics grphcs) {
        ...
        // Llama a createHelperText antes de createHintText para posicionarlo por debajo de la línea.
        createHelperText(g2);
    ...
    private void createHintText(Graphics2D g2) {
        ...
        g2.drawString(labelText, in.right - 27, (int) (in.top + textY + ft.getAscent() - size));
    }
